...
echo "Logging on as $KEYCLOAK_ADMIN in keycloak to create the crossplane client and grant it the admin role in the master realm"
...
--data-raw '
{
  ...
  "name":"crossplane",
  "clientId":"crossplane",
  "secret":"xppw_LnaEt79B47CxPEafJpXx",
